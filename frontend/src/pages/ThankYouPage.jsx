...
const ThankYouPage = () => {
  ...
  const downloadInvoice = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/payments/invoice/${booking_id}/`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
        ...
        <div className="col-lg-10">
          ...
          >
            <div className="text-center">
              ...
              <h1 className="fw-bold mb-2" style={{ color: "#28a745" }}>
                Thank You!
              </h1>
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-md-10 col-lg-9">
                ...
                <div className="alert alert-info text-center mb-4" style={{ fontSize: "1.05rem" }}>
                  <strong>Important:</strong> Go to Terminal 1, Car Park A, Level 2 for pick-up and drop-off.<br />
                  <span className="d-block mt-2">
                    <strong>Pickup location:</strong> Customers should go to Car Park A, Level 2.
                  </span>
                  <span className="d-block mt-2">
                ...
                {coupon && (
                  <div className="alert alert-success text-center mt-4 mb-0" style={{ fontSize: "1.08rem" }}>
                    <strong>Special Offer:</strong> Use code <span className="fw-bold">{coupon}</span> for a <strong>{couponDiscount}%</strong> discount on your next booking!
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="text-center text-muted" style={{ fontSize: "1.05rem" }}>
              <p>
                ...
                If you have any questions, contact us at <a href="mailto:support@dublinairportexpressparking.ie" className="text-decoration-underline text-dark">support@dublinairportexpressparking.ie</a>.
              </p>
              <p>
                Thank you for choosing <span className="fw-bold" style={{ color: "#28a745" }}>Dublin Airport Express Parking</span>.<br />
