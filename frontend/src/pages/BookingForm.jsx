...
const BookingForm = () => {
    ...
    const labelStyle = { fontWeight: 600, color: "#555", fontSize: "14px" };
    const inputStyle = {
        width: "100%",
        padding: "8px",
        marginBottom: "5px",
    ...
    const nextButtonStyle = { ...buttonStyle, backgroundColor: "#75C24B", color: "#fff" };
    ...
    useEffect(() => {
      ...
      const initializeBookingForm = async () => {
          try {
              ...
              if (bookingDetails?.booking_id && isMounted) {
                  try {
                      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/bookings/${bookingDetails.booking_id}/`, {
                          method: "GET",
                          headers: {
  ...
  if (
    ...
    <Helmet>
      ...
      <link rel="canonical" href="https://dublinairportexpressparking.ie/book/standard-meet-greet-parking/"/>
      <meta property="og:title" content="Book Now - Dublin Airport Express Parking"/>
      <meta property="og:description" content="Reserve your Dublin Airport Express Parking for a secure, hassle-free experience."/>
      <meta property="og:type" content="website"/>
      <meta property="og:url" content="https://dublinairportexpressparking.ie/book-now/"/>
      ...
      <meta name="twitter:title" content="Book Now - Dublin Airport Express Parking"/>
    ...
    <div style={{ backgroundColor: "#fff", minHeight: "100vh"}} className="container-fluid" id="booking-form">
      <div className="row mx-0 justify-content-center">
        <div className="col-12 col-md-10 col-lg-8 col-xl-6 text-center px-3 px-md-4 py-3 w-sm-95 bookingform-inner" style={{ backgroundColor: "#fff", borderRadius: "10px", boxShadow: "0 4px 24px #c2c2c240", height: "100%"}}>            
          ...
          {show72HourWarning && (
            ...
            <ul id="progressbar" className="d-flex flex-wrap justify-content-between list-unstyled mb-4 px-1">
              {steps.map((step, idx) => (
                <li
                  key={step.id}
                  className="flex-grow-1 text-center progressbar-item"
                  style={{
                    fontWeight: idx <= currentStep ? "bold" : "normal",
                    color: idx <= currentStep ? "#75C24B" : "#ccc",
