...
import standard from "../../assets/parking.jpg"
    ...
    >
      ...
      <div className='service-card-actions'>
        <div className='service-card-price'>
          <p style={{   fontSize: '20px',   fontWeight: 'bold',   color: '#073E46',   marginBottom: '5px', }}>  €{price.toFixed(2)}</p>
          {amountSaved > 0 && (
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
            <div
              style={{
                padding: '10px 20px',
                backgroundColor: service.enabled ? '#073E46' : '#aaa',
                color: '#fff',
                borderRadius: '8px',
                fontSize: '14px',
                fontWeight: 'bold',
              ...
              onMouseOut={(e) => (e.target.style.backgroundColor = '#073E46')}
