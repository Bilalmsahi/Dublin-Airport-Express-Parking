...
const PayPopup = ({ open, onClose, booking, extraAmount = null, onPaymentSuccess = null, newDepartureTime = null, newReturnTime = null, skipSuccessNavigate = false }) => {
            ...
            <div className="p-3 shadow bg-white position-relative" style={{ borderRadius: 12 }}>
              <Elements stripe={stripePromise}>
                <CheckoutForm
                  ...
                  skipSuccessNavigate={skipSuccessNavigate}
                />
              </Elements>
            </div>
          </div>
