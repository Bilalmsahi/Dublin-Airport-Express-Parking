...
const Step4BookingForm = () => {
    ...
    const downloadInvoice = async() => {
        try {
          const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/payments/invoice/${booking_id}/`,
            {
              method: "GET",
              headers: {
  ...
  return (
    <fieldset className="fieldset active">
        ...
        <div className="row justify-content-center">
            ...
            <h5 className="purple-text text-center" style={{ fontSize: "18px", fontWeight: "bold", color: "#28a745", marginTop: "20px" }}>
            ...
            <p className="text-center" style={{ fontSize: "16px", color: "#555", marginTop: "10px" }}>
                If you have any questions, feel free to contact us at <strong> support@dublinairportexpressparking.ie </strong>
            </p>
