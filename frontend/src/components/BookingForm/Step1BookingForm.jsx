  ...
  return (
    ...
    <fieldset className="fieldset active">
      <div className="form-card">
        <h2 style={{ fontSize: "16px", fontWeight: "bold", color: "#073E46", marginBottom: "15px" }}>Car Details:</h2>
        ...
        <div className="bookingform-row">
            <div className="col-7">
                <h2 className="fs-title" style={{ fontSize: "16px", fontWeight: "bold", color: "#073E46", marginBottom: "20px", marginTop: "20px" }}>
                Flight Details:
                </h2>
            </div>                       
        </div>
        ...
        <div className="bookingform-row">
          ...
          {bookingData?.userDetails?.id && <>
            ...
            <div className="bookingform-row">
                  <div className="col-7">
                      <h2 className="fs-title" style={{ fontSize: "20px", fontWeight: "bold", color: "#073E46", marginBottom: "20px" }}>
                      Your Details:
                      </h2>
                  </div>                       
              </div>
